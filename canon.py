...
UPCOMING_EMAIL_BODY_HTML = 'The book "{title}" you loaned from Yirmiyahu Library Gemach is due on <b>{due_date}</b>.' \
                           ...
                           '' \
                           '<p>If you wish to renew your book, you may call on the days that the library is open.' \
                           '<br>Books may be renewed once for an additional month.' \
                           '' \
                           '<p><b>Phone numbers:</b>' \
